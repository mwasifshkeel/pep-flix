    ...
    <main className="mb-8 flex-1 bg-zinc-700">
      <div>
        <div className='flex items-center justify-center py-10'>
          <input className='p-2 leading-8 bg-zinc-800 b text-center items-center rounded-xl outline-none focus:outline-1 focus:outline-amber-200 caret-white text-white w-[300px] md:w-[500px] lg:w-[700px]' type="text" placeholder="Enter Movie Name..." value={search} onChange={handleSearchChange} />
        </div>
